		...
		<nav class="navbar sticky-top navbar-light bg-light">
			<div class="container-fluid">
				...
				href="landingPage.jsp">Home</a></li>
			       <li class="nav-item">
			            <a class="nav-link" href="<%=request.getContextPath()%>/cRPortalServlet">Dashboard</a>
			          </li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/biddingHistory">Public Bidding History</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/itemsPage">Items</a>
						</li>
						<li class="nav-item">
			            <a class="nav-link" href="addItem.jsp">Add Items to Watchlist</a>
			          </li>
			          <li class="nav-item">
			            <a class="nav-link" href="crEditDelete.jsp">Edit/Delete User</a>
			          </li>
